...
import CommanClasses.AdminInfo;
...
public class AdminLogin extends JFrame{
	...
	public AdminLogin() throws UnknownHostException, IOException {
		...
		icon=new ImageIcon("E:\\onlineauctionsystem\\admin\\images\\index.png");
		...
		icon2=new ImageIcon("E:\\onlineauctionsystem\\admin\\images\\login.jpg");
		...
		lblNewLabel.setIcon(new ImageIcon("E:\\onlineauctionsystem\\admin\\images\\Login2.png"));
		...
		lblNewLabel_1.setIcon(new ImageIcon("E:\\onlineauctionsystem\\admin\\images\\User5.png"));
		...
		label = new JLabel("");
		label.setIcon(new ImageIcon("E:\\onlineauctionsystem\\admin\\images\\pwd3.png"));
