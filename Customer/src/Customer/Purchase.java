	...
	public void refresh() throws Exception
	{
		...
		if(status && !flag)
		{
			...
			while(it.hasNext())
			{
				sentitem=it.next();
				Barray=sentitem.b;
				File file=new File("E:\\onlineauctionsystem\\admin2\\AdminImages\\"+String.valueOf(sentitem.ID)+".txt");
				fos=new FileOutputStream(file);
				fos.write(Barray);
				image=new ImageIcon("E:\\onlineauctionsystem\\admin2\\AdminImages\\"+String.valueOf(sentitem.ID)+".txt");
